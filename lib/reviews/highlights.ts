...
export const reviewHighlights: readonly ReviewHighlight[] = [
  {
    ...
    authorPhotoUrl: null,
    rating: 5,
    text: "Travail impeccable, salon très propre, l'équipe est à l'écoute. Mes ongles tiennent 3 semaines parfaitement. Je recommande à 100 %.",
  ...
  },
  {
    ...
    authorPhotoUrl: null,
    rating: 5,
    text: "J'ai testé plusieurs salons avant de trouver celui-ci. C'est le seul où je reviens. Soin des cuticules nickel, ambiance calme, et un vrai sens du conseil sur les couleurs.",
  ...
  },
  {
    ...
    authorPhotoUrl: null,
    rating: 5,
    text: "Très contente du résultat ! La pose est rapide et précise, l'équipe prend vraiment le temps de bien faire les choses. Prix corrects et salon bien décoré.",
