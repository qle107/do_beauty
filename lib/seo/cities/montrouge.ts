  ...
  localBlocks: [
    {
      ...
      paragraphs: [
        "Montrouge borde Gentilly à l'est : les deux communes se touchent, quelque part entre la Porte de Châtillon et la Porte de Gentilly. Depuis la Mairie, l'avenue de la République ou les abords du Beffroi, il ne faut qu'une poignée de minutes en voiture, ou un court trajet en métro ligne 4 relayé par le tram T3a, pour arriver au 16 avenue Jean Jaurès. Cette proximité a fait de Do Beauty une adresse de quartier pour bon nombre de Montrougiennes, sans les contraintes de stationnement de Paris intra-muros.",
    ...
    },
    {
      ...
      paragraphs: [
        "Côté mains, la carte couvre la manucure, le vernis semi-permanent, la pose en gel et le nail art, du nude discret aux décors plus travaillés. Chaque geste se fait avec des produits professionnels et un vrai soin de l'hygiène, pour un résultat régulier qui dure. Aux beaux jours, une beauté des pieds s'ajoute volontiers au rendez-vous, pour accorder mains et pieds avant les sandales.",
        "Le regard tient une place à part : nos poses d'extensions de cils se travaillent cil à cil, du rendu naturel au plus dense, et le rehaussement de cils ouvre l'œil sans artifice. C'est le genre de soin que l'on réserve avant un événement ou simplement pour gagner du temps le matin. Avec une note de 4,6 sur 5 pour près d'une centaine d'avis Google, Do Beauty s'est fait une place de confiance auprès des habitantes de Montrouge.",
      ],
    },
  ],
  reasons: [
