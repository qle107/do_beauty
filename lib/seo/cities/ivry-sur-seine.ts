...
export const cityData: City = {
  ...
  "localFaqs": [
    {
      "question": "Combien de temps faut-il pour venir d'Ivry-sur-Seine chez Do Beauty ?",
      "answer": "Comptez environ 8 minutes en voiture, soit près de 4 km depuis le centre d'Ivry-sur-Seine, en traversant Le Kremlin-Bicêtre pour rejoindre Gentilly. Sans voiture, la ligne 7 du métro vous rapproche du tram T3a, que vous prenez à la Porte d'Ivry ou à la Porte d'Italie jusqu'à la Porte de Gentilly, à quelques minutes à pied de l'avenue Jean Jaurès."
    },
    {
